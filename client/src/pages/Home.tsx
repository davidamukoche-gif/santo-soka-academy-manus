  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="contact-section" id="contact"><div className="contact-intro"><div className="section-kicker"><span>05</span><i /> Your next move</div><h2>Ready when<br /><em>you are.</em></h2><p>Bring your questions, your ambition, and a pair of boots. Reach out to find the right next step for your player.</p></div><div className="contact-card"><div className="contact-item"><Phone size={19} /><div><small>Call or WhatsApp</small><a href="tel:+254724325653">0724325653</a></div></div><div className="contact-item"><MapPin size={19} /><div><small>Based in</small><strong>Dagoretti, Nairobi</strong></div></div><div className="contact-item"><Instagram size={19} /><div><small>Follow the journey</small><a href="https://www.instagram.com/santos_soka_academy?igsi=MXQ0ZndmcDE0OWwxdA==" target="_blank" rel="noreferrer">@santosokaacademy</a></div></div><a className="button button-lime full" href="mailto:santossokaacademykenya@gmail.com">Register for a trial <ArrowUpRight size={17} /></a></div></section>
      </main>
